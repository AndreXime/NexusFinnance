...
const sequelize = new Sequelize(databaseUrl, {
   ...
   dialect: "postgres",
   models: [
      Usuario, Transacao, BancoConta, Pagamento, Relatorio, Beneficio, BeneficioUsuario, Empresa
   ]
});
...
Usuario.belongsToMany(Beneficio, { through: BeneficioUsuario, foreignKey: 'usuarioId', as: 'beneficios' });
Beneficio.belongsToMany(Usuario, { through: BeneficioUsuario, foreignKey: 'beneficioId', as: 'usuarios' });
...
export {
   Usuario, Transacao, BancoConta, Relatorio, Pagamento, Beneficio, BeneficioUsuario, Empresa
};
