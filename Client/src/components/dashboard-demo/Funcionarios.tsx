...
return (
  <>
    ...
    <h1 className="text-center text-2xl font-bold mb-4">Quadro de funcionarios</h1>
            ...
            <div className="flex items-center gap-3">
              <div className="avatar">
                <div className="mask mask-squircle h-12 w-12">
                  <Image
                    src={funcionario.sexo=="Feminino" ? "/demo_assets/blank_feminino.png" : "/demo_assets/blank_masculino.png" }
                        width={10} height={10}    
