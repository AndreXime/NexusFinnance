      ...
      <div className="dropdown">
        ...
        <ul
          ...
          <li>
              <a>Temas</a>
              <ul className="p-2">
                <li><button onClick={() => {mudarTema("light")}}>Claro</button></li>
                <li><button onClick={() => {mudarTema("dark")}}>Escuro</button></li>
                <li><button onClick={() => {mudarTema("coffee")}}>Coffee</button></li>
                <li><button onClick={() => {mudarTema("winter")}}>Winter</button></li>
              </ul>
          </li>  
        </ul>
      </div>
